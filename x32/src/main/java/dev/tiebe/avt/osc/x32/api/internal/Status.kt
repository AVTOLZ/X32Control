package dev.tiebe.avt.osc.x32.api.internal

import com.illposed.osc.OSCMessage
import dev.tiebe.avt.osc.x32.X32OSC
import dev.tiebe.avt.osc.x32.api.channelIndex
...
class Status private constructor(private val osc: X32OSC) {
    ...
    companion object {
        @Volatile private var INSTANCES: MutableMap<X32OSC, Status> = mutableMapOf()

        fun getInstance(osc: X32OSC): Status {
