...
class QuickQOSCTest {
    private val oscClient = dev.tiebe.avt.osc.quickq.QuickQOSC("localhost", 10023, 10024)
    private val oscServer = dev.tiebe.avt.osc.quickq.QuickQOSC("localhost", 10024, 10023)
