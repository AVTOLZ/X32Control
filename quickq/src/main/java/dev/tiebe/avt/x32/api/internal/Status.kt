...
class Status private constructor(private val osc: QuickQOSC) {
    ...
    companion object {
        @Volatile private var INSTANCES: MutableMap<QuickQOSC, Status> = mutableMapOf()

        fun getInstance(osc: QuickQOSC): Status {
