...
import dev.tiebe.avt.osc.x32.biquad.BiQuadraticFilter.Companion.FilterType.*
import dev.tiebe.avt.osc.x32.commands.EQFaderSync.*
...
fun main() {
    ...
    frequencies.forEach {
        ...
        for (band in dev.tiebe.avt.osc.x32.advancedTestBands) {
